...
<head>
    ...
    <title>Thêm Voucher - Admin Panel</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-plus me-2"></i>Thêm Voucher</h1>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="code" name="code" required 
                                                   placeholder="Nhập mã voucher" value="{$smarty.post.code|default:''}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="type" name="type" required onchange="updateValueLabel()">
                                            ...
                                            <option value="percentage" {if $smarty.post.type == 'percentage'}selected{/if}>Phần trăm (%)</option>
                                            <option value="fixed" {if $smarty.post.type == 'fixed'}selected{/if}>Số tiền cố định (VNĐ)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="value" name="value" required 
                                               min="0" step="0.01" placeholder="Nhập giá trị" value="{$smarty.post.value|default:''}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" 
                                               min="0" step="0.01" placeholder="0" value="{$smarty.post.min_order_amount|default:'0'}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="max_uses" name="max_uses" 
                                               min="1" placeholder="Không giới hạn" value="{$smarty.post.max_uses|default:''}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status">
                                            <option value="active" {if $smarty.post.status == 'active' || !$smarty.post.status}selected{/if}>Hoạt động</option>
                                            <option value="inactive" {if $smarty.post.status == 'inactive'}selected{/if}>Không hoạt động</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="start_date" name="start_date" 
                                               value="{$smarty.post.start_date|default:''}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="end_date" name="end_date" 
                                               value="{$smarty.post.end_date|default:''}">
