        ...
        {if $total_pages > 1}
            <nav aria-label="Product pagination" class="mt-4">
                <ul class="pagination justify-content-center">
                    {if $current_page > 1}
                        <li class="page-item">
                            <a class="page-link" href="/?c=product&v=category&id={$category.id}&page={$current_page-1}">Trước</a>
                        </li>
                    {/if}
                    ...
                    {for $i=1 to $total_pages}
                        ...
                        {else}
                            <li class="page-item">
                                <a class="page-link" href="/?c=product&v=category&id={$category.id}&page={$i}">{$i}</a>
                            </li>
                        {/if}
                    {/for}
                    ...
                    {if $current_page < $total_pages}
                        <li class="page-item">
                            <a class="page-link" href="/?c=product&v=category&id={$category.id}&page={$current_page+1}">Sau</a>
                        </li>
                    {/if}
                </ul>
            </nav>
